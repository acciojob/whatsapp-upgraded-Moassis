...
public class WhatsappRepository {
    ...
    // public String changeAdmin(User approver, User user, Group group) throws
    // Exception {
    // // Throw "Group does not exist" if the mentioned group does not exist
    ...
    // // If user is found in a group and it is the admin, throw "Cannot
    // removeadmin"
    // // exception
    // // If user is not the admin, remove the user from the group, remove all its
    // // messages from all the databases, and update relevant
    // attributesaccordingly.
