...
public class WhatsappRepository {
    ...
    public int removeUser(User user) throws Exception {
        ...
        // return (updated number of users in the group + the updated number of messages
        // in group +
...
// HashMap<Group, List<User>> groupHashMap = new HashMap<>(); // group Name as
// key
...
// public int sendMessage(Message message, User sender, Group group) throws
// Exception {
// // Throw "Group does not exist" if the mentioned group does not exist
// // Throw "You are not allowed to send message" if the sender is not a member
// of
// // the group
// // If the message is sent successfully, return the final number of messages
// in
// // that group.
...
// public void changeAdmin(User approver, User user, Group group) throws
// Exception {
// // Throw "Group does not exist" if the mentioned group does not exist
...
// // If user is found in a group and it is the admin, throw "Cannot remove
// admin"
// // exception
// // If user is not the admin, remove the user from the group, remove all its
// // messages from all the databases, and update relevant attributes
// accordingly.
// // If user is removed successfully, return (the updated number of users in
// the
