...
public class WhatsappController {
    ...
    public Group createGroup(@RequestBody List<User> users) {
        ...
        // should be kept as the name of the second user(other than admin)
        // If there are 2+ users, the name of group should be "Group count". For
        // example, the name of first group would be "Group 1", second would be "Group
        // 2" and so on.
        // Note that a personal chat is not considered a group and the count is not
        // updated for personal chats.
        // If group is successfully created, return group.

        // For example: Consider userList1 = {Alex, Bob, Charlie}, userList2 = {Dan,
        // Evan}, userList3 = {Felix, Graham, Hugh}.
        // If createGroup is called for these userLists in the same order, their group
        // names would be "Group 1", "Evan", and "Group 2" respectively.
    ...
    // // Find the Kth latest message between start and end (excluding start and
    // end)
